...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col items-center mt-20">
      ...
      <div [ngClass]="{'dark:bg-gray-800 ':darkModeStatus, 'bg-white ': !darkModeStatus}" class="max-w-2xl px-8 py-4 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800 mt-20"
...
@Input()  darkModeStatus: boolean = false;
